 ...
 *
 * The thumbprint is a sha1 hash of the cert
 */
 ...
 * EVP_PKEY* keyPair which is a 'temporary' location (in the wolfssl case it is 
 ...
 * @param  - [Input] : pCertASCII = the b64 encoded NULL terminated certificate
 * @return - success : true
 *         - failure : false
 */
